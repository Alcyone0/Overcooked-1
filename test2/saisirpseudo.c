...
void saisie_pseudos(char *pseudo1, char *pseudo2) {
    ...
    BITMAP *arriere_plan1 = load_bitmap("C:\\Users\\ACER\\Documents\\info\\overcook\\test2\\images\\image_pr_pseudo.bmp", NULL);
    if (!arriere_plan1) {
    ...
    BITMAP *arriere_plan2 = load_bitmap("C:\\Users\\ACER\\Documents\\info\\overcook\\test2\\images\\TOUCHES.bmp", NULL);
    if (!arriere_plan2) {
        set_gfx_mode(GFX_TEXT, 0, 0, 0, 0);

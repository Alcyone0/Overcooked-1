...
int chargerimage(BITMAP **plat1,BITMAP **plat2,BITMAP **plat3) {
    *plat1 = load_bitmap("C:\\Users\\estel\\Documents\\overcooked\\recette3.bmp", NULL);
    if (!*plat1) {
        allegro_message("Erreur lors du chargement de l'imageE.");
        return -1;
    }

    *plat2 = load_bitmap("C:\\Users\\estel\\Documents\\overcooked\\recette2.bmp", NULL);
    if (!*plat2) {
        allegro_message("Erreur lors du chargement de l'imageE.");
        return -1;
    }

    *plat3 = load_bitmap("C:\\Users\\estel\\Documents\\overcooked\\recette1.bmp", NULL);
    if (!*plat3) {
        allegro_message("Erreur lors du chargement de l'imageE.");
        return -1;
    }
